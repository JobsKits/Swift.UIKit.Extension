...
public extension PDFThumbnailView {
    @discardableResult func byPDFView(to pdfView: PDFView) -> Self { self.pdfView = pdfView; return self }
    @discardableResult func byLayoutMode(_ mode: PDFThumbnailLayoutMode) -> Self { self.layoutMode = mode; return self }
    @discardableResult func byThumbnailSize(_ size: CGSize) -> Self { self.thumbnailSize = size; return self }
